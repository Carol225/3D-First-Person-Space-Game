                            ...
                            Entity& entity2)
{
	...
	Vector3 momentum1 = entity1.getVelocity() * mass1;
	Vector3 momentum2 = entity2.getVelocity() * mass2;
	...
	if(!velocity_to_move1.isSameHemisphere(e1_to_e2))
		return;  // already moving apart

	assert(mass1 > 0.0);
	assert(mass2 > 0.0);
	Vector3 new_velocity1 = average_velocity + velocity_to_move2 * mass2 / mass1;
	Vector3 new_velocity2 = average_velocity + velocity_to_move1 * mass1 / mass2;

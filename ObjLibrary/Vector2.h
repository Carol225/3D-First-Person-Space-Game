...
//  isEqualTo
//
//  Purpose: To determine if this Vector2 and another Vector2
//           are equal, according to tolerance
//           VECTOR2_NORM_TOLERANCE.  For an exact comparison,
...
//    <1> isFinite()
//    <2> other.isFinite()
//  Returns: Whether this Vector2 is equal to other.
//  Side Effect: N/A
//
	bool isDistanceEqualTo (const Vector2& other) const
	{
		if(fabs(x - other.x) > VECTOR2_NORM_TOLERANCE)
			return false;
		if(fabs(y - other.y) > VECTOR2_NORM_TOLERANCE)
			return false;
		return true;
	}
